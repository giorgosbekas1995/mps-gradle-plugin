...
* `excludeModels` - optional list of models to exclude from generate. RegEx can be used for excluding multiple models.
* `modules` - optional list of modules to generate. Expects ordinary name (w/o virtual folders). RegEx can be used for excluding multiple modules.
...
* `excludeModules` - optional list of modules to exclude from generate. RegEx can be used for excluding multiple modules.
